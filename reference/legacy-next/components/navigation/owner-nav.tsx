...
import { Anchor, LayoutDashboard, Ship, Briefcase, MessageSquare, Settings, LogOut, Users } from "lucide-react"
...
export function OwnerNav() {
  ...
  const navItems = [
    ...
    { href: "/owner/vessels", label: "Vessels", icon: Ship },
    { href: "/owner/jobs", label: "Jobs", icon: Briefcase },
    { href: "/owner/candidates", label: "Candidates", icon: Users },
