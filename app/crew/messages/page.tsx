...
export default function CrewMessagesPage() {
  ...
  const threads = [
    ...
    },
    {
      ...
      lastMessage: "Thank you for your application. We'd like to...",
      timestamp: "Yesterday",
      unread: 0,
      avatar: "/placeholder.svg?height=40&width=40",
    },
    {
      ...
      name: "Michael Chen",
      vessel: "M/Y Serenity",
      lastMessage: "Your profile looks great! Are you still available?",
      ...
      <div className="flex-1 py-8">
        <div className="container max-w-7xl">
          <div className="mb-6">
            ...
            <p className="text-muted-foreground">Communicate with yacht owners and captains</p>
          </div>
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-start justify-between mb-1">
                              <div>
                                ...
                                <p className="text-xs text-muted-foreground truncate">{thread.vessel}</p>
                              </div>
                              {thread.unread > 0 && (
                                <Badge
                                  variant="default"
              ...
              <div className="flex flex-col">
                ...
                <div className="p-4 border-b flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-semibold">Captain James Wilson</p>
                      <p className="text-sm text-muted-foreground">M/Y Azure Dream</p>
                    </div>
                  </div>
